...
## Introduction
The goal of the "glmGraph" package is to learn an approximate multivariate distribution from data. Suppose the target multivariate distribution has a density $f(x_1, x_2, ..., x_n)$, we model it using a graphical model with parametric components. 
